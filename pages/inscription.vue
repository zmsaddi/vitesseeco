    ...
    <div class="container-custom max-w-md">
      <div class="card p-6 md:p-8">
        ...
        <div class="flex items-center gap-4 my-6">
          ...
          <span class="text-text-secondary text-xs">{{ $t('common.or') || 'ou' }}</span>
          <div class="flex-1 border-t border-dark-tertiary" />
        </div>

        <a href="/api/auth/google" class="w-full flex items-center justify-center gap-3 py-3 px-4 rounded-lg border border-dark-tertiary bg-dark-secondary hover:bg-dark-tertiary transition-colors text-white font-medium">
