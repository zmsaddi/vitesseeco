  ...
  fields: [
    {
      ...
      fields: [
        { name: 'isOffered', title: 'نعرض التركيب', type: 'boolean', initialValue: false },
        {
          name: 'feeEuros', title: 'رسوم التركيب (€)', type: 'number',
          validation: (Rule) => Rule.min(0).max(500),
        },
        {
          name: 'label', title: 'التسمية المعروضة', type: 'localizedString',
