...
export default defineType({
  ...
  fields: [
    ...
    },
    {
      ...
      fields: [
        ...
        { name: 'addressLine2', title: 'تكملة العنوان (شقة/طابق)', type: 'string', readOnly: true },
  ...
  preview: {
    ...
    prepare({ title, status, total, customer, date, payment, shipping }) {
      ...
      const payMap: Record<string, string> = { in_store: '🏪', cod: '💵', stripe: '💳', paypal: '🅿️', klarna: '🛍️', bank_transfer: '🏦' }
