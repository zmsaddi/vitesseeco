/**
 * Merchant Center feed for the de market.
 *
 * Register this URL against the countries the de pages are priced for. The
...
export default defineEventHandler((event) => serveMerchantFeed(event, 'de'))
